...
def apply_rotary_emb(freqs, t, start_index=0, scale=1.):
    ...
    t_left, t_middle, t_right = t[..., :start_index], t[...,
...
class RotaryEmbedding(nn.Module):
    ...
    def prepare_freqs(self, num_patches, device='cuda', dtype=torch.float32, offset=0):
        ...
        freqs_scaled = torch.outer(seq_pos.type(
            self.freqs.dtype), self.freqs).repeat_interleave(repeats=2, dim=-1)
