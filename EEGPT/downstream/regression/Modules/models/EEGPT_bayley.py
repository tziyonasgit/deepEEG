...
EEGPT pretraining
================================================================
This module adapts and documents EEG Pretrain Transformers codebase
...
class EEGPTRegression(nn.Module):
    def __init__(self,
                 in_channels=22,
                 img_size=[58, 2000],
                 patch_stride=64,
                 ...
                 ** kwargs):
        """
        Regression head built on top of EEGTransformer encoder
    ...
    def forward(self, x, chan_ids=None, return_patch_tokens=False, return_all_tokens=False, **kwargs):
        ...
        x = self.head(feats)  # self.head: Linear(512 -> 1)
...
if __name__ == "__main__":
    ...
    model = EEGPTRegression(4, in_channels=len(ch_names), img_size=[len(
