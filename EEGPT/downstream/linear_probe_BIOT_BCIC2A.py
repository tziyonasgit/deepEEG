...
for i in range(1,10):
    ...
    trainer = pl.Trainer(accelerator='cuda',
                         ...
                         logger=[pl_loggers.TensorBoardLogger('./logs/', name="BIOT_BCIC2A_tb", version="subject{}_model{}".format(i,pretrain_model_choice)), 
                                 pl_loggers.CSVLogger('./logs/', name="BIOT_BCIC2A_csv")])
