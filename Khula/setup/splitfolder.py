...
output_root = '/scratch/chntzi001/khula/processedSynthetic/'
...
with open('/home/chntzi001/deepEEG/setUpKhula/extra/khulasubs.csv', newline='') as csvfile:
...
for split_name, subjects in splits.items():
    for subject in subjects:
        for filename, session in subject_files[subject]:
            ...
            if split_name == 'train':
                with open("trainSynthetic.txt", "a") as f:
                    f.writelines(src_path + "_" + dst_path + "\n")
            elif split_name == 'val':
                with open("valSynthetic.txt", "a") as f:
                    f.writelines(src_path + "_" + dst_path + "\n")
            elif split_name == 'test':
                with open("testSynthetic.txt", "a") as f:
                    f.writelines(src_path + "_" + dst_path + "\n")
