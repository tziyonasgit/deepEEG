...
from engine_for_finetuning_EEGPT import train_one_epoch, evaluate, getVarOutputs
...
def main(args, ds_init):
    ...
    args.output_dir = f"/scratch/chntzi001/khula/checkpoints/finetune_khula_eegpt/{classification}/18-08/{run_name}"
    output_dir = args.output_dir
    args.log_dir = f"/home/chntzi001/deepEEG/EEGPT/downstream/log/{classification}/18-08/{run_name}"
    os.makedirs(output_dir, exist_ok=True)
    os.makedirs(args.log_dir, exist_ok=True)
    tsneplots = f"/scratch/chntzi001/khula/checkpoints/finetune_khula_eegpt/{classification}/18-08/{run_name}/tsne_plots"
