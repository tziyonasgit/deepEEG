...
from Khula.EEGPT.downstream.bayley.engine_for_finetuning_bayley import train_one_epoch, evaluate, getVarOutputs
from utils import NativeScalerWithGradNormCount as NativeScaler
import utils
from Khula.EEGPT.downstream.bayley.Modules.models.EEGPT_bayley import EEGPTRegression, getOutput
...
def get_dataset(args):
    if args.dataset == 'KHULA':
        ...
        filepath = "/scratch/chntzi001/khula/processedBayley/"
...
def main(args, ds_init):
    ...
    args.output_dir = f"/scratch/chntzi001/khula/checkpoints/finetune_khula_eegpt/bayley/15-08/{run_name}"
    output_dir = args.output_dir
    args.log_dir = f"/home/chntzi001/deepEEG/EEGPT/downstream/log/bayley/15-08/{run_name}"
    os.makedirs(output_dir, exist_ok=True)
    os.makedirs(args.log_dir, exist_ok=True)
    tsneplots = f"/scratch/chntzi001/khula/checkpoints/finetune_khula_eegpt/bayley/15-08/{run_name}/tsne_plots"
