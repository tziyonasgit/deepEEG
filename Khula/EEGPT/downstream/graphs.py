...
def newgraph(set, metric):  # set = val/test, metric = loss/acc
    save_dir = "/home/chntzi001/deepEEG/EEGPT/downstream/log"
    log_dirs = glob.glob(
        '/scratch/chntzi001/khula/checkpoints/finetune_khula_eegpt/lr*/')
    log_files = []
        ...
        with open(log_file_path, 'r') as f:
            for line in f:
                ...
                try:
                    ...
                    if 'epoch' in data and 'max_accuracy_val' in data:
                        best_val_acc = data['max_accuracy_val']
