...
def get_models(args):
    ...
    # the model predicts the probability of each class, so the output layer is a linear layer with num_classes outputs
    # the classifier head is a linear layer with num_classes outputs
    # the classes are defined in the dataset, so we need to set the num_classes parameter in the model
    # so I do not need to set the num_classes parameter in the model
