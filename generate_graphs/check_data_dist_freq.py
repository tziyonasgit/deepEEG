""" 
Purpose: Loads a sample of EEG segments from your train/test pickle folders, 
        computes each segment’s dominant frequency and compares the distributions 
        between train and test by plotting overlaid histograms.
